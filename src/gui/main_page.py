...
def main_page(page: ft.Page):
    ...
    # Status message (defined early for use in callbacks)
    ...
    def get_field_width(e=None):
        # Calculate responsive width based on window size
        return max(200, (page.window.width - 100) // 4)
    ...
    def on_generate_click(e):
        ...
        on_password_change()  # Update strength indicator
    ...
    def on_export_click(e):
        """Handle export button click - export all passwords to CSV."""
        ...
        try:
            ...
            # Get the instance directory for the database
            export_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "instance")
        ...
        content=ft.Column(
            [
                ...
                ft.Row(
                    [
                        ft.ElevatedButton(
                            content=ft.Row([ft.Icon(ft.Icons.ADD, size=18), ft.Text("Add")], spacing=5),
                            on_click=on_add_click,
                            height=40,
                        ),
                        ft.ElevatedButton(
                            content=ft.Row([ft.Icon(ft.Icons.AUTO_AWESOME, size=18), ft.Text("Generate")], spacing=5),
                            on_click=on_generate_click,
                            height=40,
                        ),
                        ft.ElevatedButton(
                            content=ft.Row([ft.Icon(ft.Icons.SEARCH, size=18), ft.Text("Search")], spacing=5),
                            on_click=on_search_click,
                            height=40,
                        ),
                        ft.ElevatedButton(
                            content=ft.Row([ft.Icon(ft.Icons.EDIT, size=18), ft.Text("Update")], spacing=5),
                            on_click=on_update_click,
                            height=40,
                        ),
                        ft.ElevatedButton(
                            content=ft.Row([ft.Icon(ft.Icons.DELETE, size=18), ft.Text("Delete")], spacing=5),
